					...
					.append(
						...
						.append( 
							...
							,$('<div>')
								...
								.append(
									$('<a class="left carousel-control" href="#slider-'+val['content']['ID']+'" role="button" data-slide="prev"></a>')
										.append('<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="sr-only">Previous</span>')
									,$('<a class="right carousel-control" href="#slider-'+val['content']['ID']+'" role="button" data-slide="next">')
										.append('<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><span class="sr-only">Next</span>')
								)
							,$('<div>')
								.addClass('pag-image')
							,$('<div>').append(
