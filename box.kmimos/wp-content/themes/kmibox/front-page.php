...
get_header(); ?>
	...
	<header class="row">
		<aside id="top"> 
			<div class="container">
				<img src="<?php echo get_home_url(); ?>/img/logo-500x148.png"  >
			</div>
		</aside>
		<article>
			<div class="container" id="banner">
				...
				<div id="banner-text" class="col-xs-12 col-sm-12 col-md-6">
					...
					<br>	
					<a href="<?php echo get_home_url(); ?>/quiero-mi-kmibox" class="btn-kmibox">Quiero mi kmiBOX</a>	
				</div>
	...
	<section id="como-funciona" class="row text-center">
		...
		<article class="col-sm-12 col-md-6">
			<img src="<?php echo get_home_url(); ?>/img/gato.png" class="img-responsive" width="300px">
			<p>
				Cada mes preparamos una caja especial para tu consentido con juguetes, snacks y productos sorpresa
			</p>
		</article>
		<article class="col-sm-12 col-md-6">
			<img src="<?php echo get_home_url(); ?>/img/camion.png" class="img-responsive" width="300px">
			<p>
	...
	<section class="row text-center">
		<h2>¿Qué lleva dentro una <img src="<?php echo get_home_url(); ?>/img/logo-text.png" class="logo-text"> ?</h2>
		<article class="col-sm-12">
			<img src="<?php echo get_home_url(); ?>/img/Caja.png" class="img-responsive" width="100%">
		</article>
		<p class="col-sm-12">Todos los artículos de la <img src="<?php echo get_home_url(); ?>/img/logo-text.png" class="logo-text"> son suministrados por <img src="<?php echo get_home_url(); ?>/img/Gran pet 1.png" class="logo-text" width="16%"></p>
	</section>

	<section class="row back-kmibox text-center">
		<h2>¿Cómo consigo mi <img src="<?php echo get_home_url(); ?>/img/logo-white-text.png" class="logo-text" width="20%"> ?</h2>
	...
	<section class="row text-center section-red">
		...
		<article class="col-xs-8 col-xs-offset-2 col-md-3 col-sm-offset-1 col-md-offset-1">
			<img src="<?php echo get_home_url(); ?>/img/Peronaje 3.png" class="img-responsive">
		</article>
		...
		<article class="col-xs-6 col-md-3">
			<img src="<?php echo get_home_url(); ?>/img/Personaje 2.png" class="img-responsive">
		</article>
	...
	<section class="row text-center">
		...
		<br>	
		<a href="<?php echo get_permalink(); ?>/quiero-mi-kmibox" class="btn-kmibox">Quiero mi kmiBOX</a>	
	</section>
