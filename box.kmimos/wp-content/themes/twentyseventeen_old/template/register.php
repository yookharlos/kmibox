...
<header class="row">
	...
	<div class="container " id="banner">
		<article class="col-sm-6">
			...
			<img src="<?php echo get_home_url(); ?>/img/personaje-400x353.png" class="img-responsive hidden-xs hidden-sm">
		</article>
			...
			<form class="inline-form">
				...
				<div class="form-group row">
					...
					<aside class="col-sm-12 text-center">
						<br>
						<a href="<?php echo get_home_url(); ?>/inicio-sesion" > <h4>Iniciar sesion</h4> </a>
					</aside>
				</div>
			</form>
		</article>
